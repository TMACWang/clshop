  ...
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="regisModalFlag=true" v-if="!nickName">注册</a>
    ...
    <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModalFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">登录llllll</div>
    ...
    <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':regisModalFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button class="md-close" @click="regisModalFlag=false">Close</button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
            ...
            <ul>
              ...
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input type="password" tabindex="2"  name="password" v-model="userPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="密码" @keyup.enter="register">
              </li>
            </ul>
          </div>
          <div class="login-wrap">
    ...
    <div class="md-overlay" v-if="regisModalFlag" @click="regisModalFlag=false"></div>
  </header>
</template>
...
export default{
  ...
  methods: {
    ...
    register () {
      ...
      this.$http.post('/users/register', {userName, userPwd})
      .then(res => {
        console.log(res)
